  ...
  return (
    <div onWheel={() => stickyhead()}>
      <div className="canvas">
        ...
        <div class="menu">
            <a href="#"  onclick="myhome()"><FaHome className="menuicons"></FaHome></a>
            <a href="#" onclick="myabt()"><FaUserCircle className="menuicons"></FaUserCircle></a>
            <a href="#"><FaBriefcase className="menuicons"></FaBriefcase></a>
            <a href="#"><FaGlobe className="menuicons"></FaGlobe></a>
            <a href="#"><FaFacebookMessenger className="menuicons"></FaFacebookMessenger></a>
        </div>
